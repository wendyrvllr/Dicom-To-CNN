...
from library_dicom.model.segmentation.rtstruct.RTSS_Writer import RTSS_Writer
from library_dicom.model.segmentation.dicom_seg.DICOMSEG_Writer import DICOMSEG_Writer
from library_dicom.model.segmentation.nifti.Nifti_Writer import Nifti_Writer
...
class ExportSegmentation_Writer : 
    ...
    def __init__(self, segmentation:sitk.Image, serie_path:str, mode:str):
        ...
        Args:
            ...
            mode ([str]): ['rtstruct' or 'dicomseg' or 'nifti']
        """
    ...
    def is_segmentation_in_good_modality(self):
        ...
        if self.mode == 'nifti' : 
            if str(type(self.segmentation)) != "<class 'SimpleITK.SimpleITK.Image'>" : 
                raise Exception ('For NIFTI format, segmentation has to be a SITK Image')
