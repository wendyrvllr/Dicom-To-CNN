...
def generate_merged_file(json_path:str):
...
def find_non_intersting_series(json_merged_file_path:str):
...
def find_studies_over_two_series(json_merged_file_path:str):
    ...
    Returns:
        [list]: [Return the list of each serie path which belong to a study with more than 2 series]
    """
    data = json.load(open(json_merged_file_path))
    number = 0
    series_to_check=[]
...
def find_studies_with_two_series(json_merged_file_path:str):
    ...
    Returns:
        [list]: [Return the list of each serie path which belong to a study with 2 series]
    """
    data = json.load(open(json_merged_file_path))
